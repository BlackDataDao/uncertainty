...
import os
import certifi
# # from openai import AuthenticationError, OpenAIError, Open # OLD
from openai import AuthenticationError, OpenAIError, AsyncOpenAI # NEWAI # OLD
...
def main_only_recommend_ds(input_file):
 ...
 # --- Remove '_new' from all column names in the output file ---
        try:
            df_out = pd.read_csv(output_csv_filename, encoding="utf-8-sig")
            df_out.rename(
...
def main_only_recommend_batch(input_file,model="gpt-4o-mini"):
    """
    Uses existing Q1 reasoning from a previous output file to generate only Q2 recommendations
    using the deepseek-chat model.
...
main_only_recommend_ds("r_recommendations_main5_20250525_120043_google.csv")  # Replace with your input file
# recommend()